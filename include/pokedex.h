...
extern const u8 DEX_ENTRY_BULBASAUR[];
extern const u8 DEX_ENTRY_IVYSAUR[];
extern const u8 DEX_ENTRY_VENUSAUR[];
extern const u8 DEX_ENTRY_CHARMANDER[];
extern const u8 DEX_ENTRY_CHARMELEON[];
extern const u8 DEX_ENTRY_CHARIZARD[];
extern const u8 DEX_ENTRY_SQUIRTLE[];
extern const u8 DEX_ENTRY_WARTORTLE[];
extern const u8 DEX_ENTRY_BLASTOISE[];
extern const u8 DEX_ENTRY_CATERPIE[];
extern const u8 DEX_ENTRY_METAPOD[];
extern const u8 DEX_ENTRY_BUTTERFREE[];
extern const u8 DEX_ENTRY_WEEDLE[];
extern const u8 DEX_ENTRY_KAKUNA[];
extern const u8 DEX_ENTRY_BEEDRILL[];
extern const u8 DEX_ENTRY_PIDGEY[];
extern const u8 DEX_ENTRY_PIDGEOTTO[];
extern const u8 DEX_ENTRY_PIDGEOT[];
extern const u8 DEX_ENTRY_RATTATA[];
extern const u8 DEX_ENTRY_RATICATE[];
extern const u8 DEX_ENTRY_SPEAROW[];
extern const u8 DEX_ENTRY_FEAROW[];
extern const u8 DEX_ENTRY_EKANS[];
extern const u8 DEX_ENTRY_ARBOK[];
extern const u8 DEX_ENTRY_PIKACHU[];
extern const u8 DEX_ENTRY_RAICHU[];
extern const u8 DEX_ENTRY_SANDSHREW[];
extern const u8 DEX_ENTRY_SANDSLASH[];
extern const u8 DEX_ENTRY_NIDORANF[];
extern const u8 DEX_ENTRY_NIDORINA[];
extern const u8 DEX_ENTRY_NIDOQUEEN[];
extern const u8 DEX_ENTRY_NIDORANM[];
extern const u8 DEX_ENTRY_NIDORINO[];
extern const u8 DEX_ENTRY_NIDOKING[];
extern const u8 DEX_ENTRY_CLEFAIRY[];
extern const u8 DEX_ENTRY_CLEFABLE[];
extern const u8 DEX_ENTRY_VULPIX[];
extern const u8 DEX_ENTRY_NINETALES[];
extern const u8 DEX_ENTRY_JIGGLYPUFF[];
extern const u8 DEX_ENTRY_WIGGLYTUFF[];
extern const u8 DEX_ENTRY_ZUBAT[];
extern const u8 DEX_ENTRY_GOLBAT[];
extern const u8 DEX_ENTRY_ODDISH[];
extern const u8 DEX_ENTRY_GLOOM[];
extern const u8 DEX_ENTRY_VILEPLUME[];
extern const u8 DEX_ENTRY_PARAS[];
extern const u8 DEX_ENTRY_PARASECT[];
extern const u8 DEX_ENTRY_VENONAT[];
extern const u8 DEX_ENTRY_VENOMOTH[];
extern const u8 DEX_ENTRY_DIGLETT[];
extern const u8 DEX_ENTRY_DUGTRIO[];
extern const u8 DEX_ENTRY_MEOWTH[];
extern const u8 DEX_ENTRY_PERSIAN[];
extern const u8 DEX_ENTRY_PSYDUCK[];
extern const u8 DEX_ENTRY_GOLDUCK[];
extern const u8 DEX_ENTRY_MANKEY[];
extern const u8 DEX_ENTRY_PRIMEAPE[];
extern const u8 DEX_ENTRY_GROWLITHE[];
extern const u8 DEX_ENTRY_ARCANINE[];
extern const u8 DEX_ENTRY_POLIWAG[];
extern const u8 DEX_ENTRY_POLIWHIRL[];
extern const u8 DEX_ENTRY_POLIWRATH[];
extern const u8 DEX_ENTRY_ABRA[];
extern const u8 DEX_ENTRY_KADABRA[];
extern const u8 DEX_ENTRY_ALAKAZAM[];
extern const u8 DEX_ENTRY_MACHOP[];
extern const u8 DEX_ENTRY_MACHOKE[];
extern const u8 DEX_ENTRY_MACHAMP[];
extern const u8 DEX_ENTRY_BELLSPROUT[];
extern const u8 DEX_ENTRY_WEEPINBELL[];
extern const u8 DEX_ENTRY_VICTREEBEL[];
extern const u8 DEX_ENTRY_TENTACOOL[];
extern const u8 DEX_ENTRY_TENTACRUEL[];
extern const u8 DEX_ENTRY_GEODUDE[];
extern const u8 DEX_ENTRY_GRAVELER[];
extern const u8 DEX_ENTRY_GOLEM[];
extern const u8 DEX_ENTRY_PONYTA[];
extern const u8 DEX_ENTRY_RAPIDASH[];
extern const u8 DEX_ENTRY_SLOWPOKE[];
extern const u8 DEX_ENTRY_SLOWBRO[];
extern const u8 DEX_ENTRY_MAGNEMITE[];
extern const u8 DEX_ENTRY_MAGNETON[];
extern const u8 DEX_ENTRY_FARFETCHD[];
extern const u8 DEX_ENTRY_DODUO[];
...
extern const u8 DEX_ENTRY_GASTLY[];
extern const u8 DEX_ENTRY_HAUNTER[];
extern const u8 DEX_ENTRY_GENGAR[];
extern const u8 DEX_ENTRY_ONIX[];
extern const u8 DEX_ENTRY_DROWZEE[];
extern const u8 DEX_ENTRY_HYPNO[];
extern const u8 DEX_ENTRY_KRABBY[];
extern const u8 DEX_ENTRY_KINGLER[];
extern const u8 DEX_ENTRY_VOLTORB[];
extern const u8 DEX_ENTRY_ELECTRODE[];
extern const u8 DEX_ENTRY_EXEGGCUTE[];
extern const u8 DEX_ENTRY_EXEGGUTOR[];
extern const u8 DEX_ENTRY_CUBONE[];
extern const u8 DEX_ENTRY_MAROWAK[];
extern const u8 DEX_ENTRY_HITMONLEE[];
extern const u8 DEX_ENTRY_HITMONCHAN[];
extern const u8 DEX_ENTRY_LICKITUNG[];
extern const u8 DEX_ENTRY_KOFFING[];
extern const u8 DEX_ENTRY_WEEZING[];
extern const u8 DEX_ENTRY_RHYHORN[];
extern const u8 DEX_ENTRY_RHYDON[];
extern const u8 DEX_ENTRY_CHANSEY[];
extern const u8 DEX_ENTRY_TANGELA[];
extern const u8 DEX_ENTRY_KANGASKHAN[];
extern const u8 DEX_ENTRY_HORSEA[];
extern const u8 DEX_ENTRY_SEADRA[];
extern const u8 DEX_ENTRY_GOLDEEN[];
extern const u8 DEX_ENTRY_SEAKING[];
extern const u8 DEX_ENTRY_STARYU[];
extern const u8 DEX_ENTRY_STARMIE[];
extern const u8 DEX_ENTRY_MR_MIME[];
extern const u8 DEX_ENTRY_SCYTHER[];
extern const u8 DEX_ENTRY_JYNX[];
extern const u8 DEX_ENTRY_ELECTABUZZ[];
extern const u8 DEX_ENTRY_MAGMAR[];
extern const u8 DEX_ENTRY_PINSIR[];
extern const u8 DEX_ENTRY_TAUROS[];
extern const u8 DEX_ENTRY_MAGIKARP[];
extern const u8 DEX_ENTRY_GYARADOS[];
extern const u8 DEX_ENTRY_LAPRAS[];
extern const u8 DEX_ENTRY_DITTO[];
extern const u8 DEX_ENTRY_EEVEE[];
extern const u8 DEX_ENTRY_VAPOREON[];
extern const u8 DEX_ENTRY_JOLTEON[];
extern const u8 DEX_ENTRY_FLAREON[];
extern const u8 DEX_ENTRY_PORYGON[];
extern const u8 DEX_ENTRY_OMANYTE[];
extern const u8 DEX_ENTRY_OMASTAR[];
extern const u8 DEX_ENTRY_KABUTO[];
extern const u8 DEX_ENTRY_KABUTOPS[];
extern const u8 DEX_ENTRY_AERODACTYL[];
extern const u8 DEX_ENTRY_SNORLAX[];
extern const u8 DEX_ENTRY_ARTICUNO[];
extern const u8 DEX_ENTRY_ZAPDOS[];
extern const u8 DEX_ENTRY_MOLTRES[];
extern const u8 DEX_ENTRY_DRATINI[];
extern const u8 DEX_ENTRY_DRAGONAIR[];
extern const u8 DEX_ENTRY_DRAGONITE[];
extern const u8 DEX_ENTRY_MEWTWO[];
extern const u8 DEX_ENTRY_MEW[];
extern const u8 DEX_ENTRY_CHIKORITA[];
extern const u8 DEX_ENTRY_BAYLEEF[];
extern const u8 DEX_ENTRY_MEGANIUM[];
extern const u8 DEX_ENTRY_CYNDAQUIL[];
extern const u8 DEX_ENTRY_QUILAVA[];
extern const u8 DEX_ENTRY_TYPHLOSION[];
extern const u8 DEX_ENTRY_TOTODILE[];
extern const u8 DEX_ENTRY_CROCONAW[];
extern const u8 DEX_ENTRY_FERALIGATR[];
extern const u8 DEX_ENTRY_SENTRET[];
extern const u8 DEX_ENTRY_FURRET[];
extern const u8 DEX_ENTRY_HOOTHOOT[];
extern const u8 DEX_ENTRY_NOCTOWL[];
extern const u8 DEX_ENTRY_LEDYBA[];
extern const u8 DEX_ENTRY_LEDIAN[];
extern const u8 DEX_ENTRY_SPINARAK[];
extern const u8 DEX_ENTRY_ARIADOS[];
extern const u8 DEX_ENTRY_CROBAT[];
extern const u8 DEX_ENTRY_CHINCHOU[];
extern const u8 DEX_ENTRY_LANTURN[];
extern const u8 DEX_ENTRY_PICHU[];
extern const u8 DEX_ENTRY_CLEFFA[];
extern const u8 DEX_ENTRY_IGGLYBUFF[];
extern const u8 DEX_ENTRY_TOGEPI[];
extern const u8 DEX_ENTRY_TOGETIC[];
extern const u8 DEX_ENTRY_NATU[];
extern const u8 DEX_ENTRY_XATU[];
extern const u8 DEX_ENTRY_MAREEP[];
extern const u8 DEX_ENTRY_FLAAFFY[];
extern const u8 DEX_ENTRY_AMPHAROS[];
extern const u8 DEX_ENTRY_BELLOSSOM[];
extern const u8 DEX_ENTRY_MARILL[];
extern const u8 DEX_ENTRY_AZUMARILL[];
extern const u8 DEX_ENTRY_SUDOWOODO[];
extern const u8 DEX_ENTRY_POLITOED[];
extern const u8 DEX_ENTRY_HOPPIP[];
extern const u8 DEX_ENTRY_SKIPLOOM[];
extern const u8 DEX_ENTRY_JUMPLUFF[];
extern const u8 DEX_ENTRY_AIPOM[];
extern const u8 DEX_ENTRY_SUNKERN[];
extern const u8 DEX_ENTRY_SUNFLORA[];
extern const u8 DEX_ENTRY_YANMA[];
extern const u8 DEX_ENTRY_WOOPER[];
extern const u8 DEX_ENTRY_QUAGSIRE[];
extern const u8 DEX_ENTRY_ESPEON[];
extern const u8 DEX_ENTRY_UMBREON[];
extern const u8 DEX_ENTRY_MURKROW[];
extern const u8 DEX_ENTRY_SLOWKING[];
extern const u8 DEX_ENTRY_MISDREAVUS[];
extern const u8 DEX_ENTRY_UNOWN[];
extern const u8 DEX_ENTRY_WOBBUFFET[];
extern const u8 DEX_ENTRY_GIRAFARIG[];
extern const u8 DEX_ENTRY_PINECO[];
extern const u8 DEX_ENTRY_FORRETRESS[];
extern const u8 DEX_ENTRY_DUNSPARCE[];
extern const u8 DEX_ENTRY_GLIGAR[];
extern const u8 DEX_ENTRY_STEELIX[];
extern const u8 DEX_ENTRY_SNUBBULL[];
extern const u8 DEX_ENTRY_GRANBULL[];
extern const u8 DEX_ENTRY_QWILFISH[];
extern const u8 DEX_ENTRY_SCIZOR[];
extern const u8 DEX_ENTRY_SHUCKLE[];
extern const u8 DEX_ENTRY_HERACROSS[];
extern const u8 DEX_ENTRY_SNEASEL[];
extern const u8 DEX_ENTRY_TEDDIURSA[];
extern const u8 DEX_ENTRY_URSARING[];
extern const u8 DEX_ENTRY_SLUGMA[];
extern const u8 DEX_ENTRY_MAGCARGO[];
extern const u8 DEX_ENTRY_SWINUB[];
extern const u8 DEX_ENTRY_PILOSWINE[];
extern const u8 DEX_ENTRY_CORSOLA[];
extern const u8 DEX_ENTRY_REMORAID[];
extern const u8 DEX_ENTRY_OCTILLERY[];
extern const u8 DEX_ENTRY_DELIBIRD[];
extern const u8 DEX_ENTRY_MANTINE[];
extern const u8 DEX_ENTRY_SKARMORY[];
extern const u8 DEX_ENTRY_HOUNDOUR[];
extern const u8 DEX_ENTRY_HOUNDOOM[];
extern const u8 DEX_ENTRY_KINGDRA[];
extern const u8 DEX_ENTRY_PHANPY[];
extern const u8 DEX_ENTRY_DONPHAN[];
extern const u8 DEX_ENTRY_PORYGON2[];
extern const u8 DEX_ENTRY_STANTLER[];
extern const u8 DEX_ENTRY_SMEARGLE[];
extern const u8 DEX_ENTRY_TYROGUE[];
extern const u8 DEX_ENTRY_HITMONTOP[];
extern const u8 DEX_ENTRY_SMOOCHUM[];
extern const u8 DEX_ENTRY_ELEKID[];
extern const u8 DEX_ENTRY_MAGBY[];
extern const u8 DEX_ENTRY_MILTANK[];
extern const u8 DEX_ENTRY_BLISSEY[];
extern const u8 DEX_ENTRY_RAIKOU[];
extern const u8 DEX_ENTRY_ENTEI[];
extern const u8 DEX_ENTRY_SUICUNE[];
extern const u8 DEX_ENTRY_LARVITAR[];
extern const u8 DEX_ENTRY_PUPITAR[];
extern const u8 DEX_ENTRY_TYRANITAR[];
extern const u8 DEX_ENTRY_LUGIA[];
extern const u8 DEX_ENTRY_HOOH[];
extern const u8 DEX_ENTRY_CELEBI[];
extern const u8 DEX_ENTRY_TREECKO[];
extern const u8 DEX_ENTRY_GROVYLE[];
extern const u8 DEX_ENTRY_SCEPTILE[];
extern const u8 DEX_ENTRY_TORCHIC[];
extern const u8 DEX_ENTRY_COMBUSKEN[];
extern const u8 DEX_ENTRY_BLAZIKEN[];
extern const u8 DEX_ENTRY_MUDKIP[];
extern const u8 DEX_ENTRY_MARSHTOMP[];
extern const u8 DEX_ENTRY_SWAMPER[];
extern const u8 DEX_ENTRY_POOCHYENA[];
extern const u8 DEX_ENTRY_MIGHTYENA[];
extern const u8 DEX_ENTRY_ZIGZAGOON[];
extern const u8 DEX_ENTRY_LINOONE[];
extern const u8 DEX_ENTRY_WURMPLE[];
extern const u8 DEX_ENTRY_SILCOON[];
extern const u8 DEX_ENTRY_BEAUTIFLY[];
extern const u8 DEX_ENTRY_CASCOON[];
extern const u8 DEX_ENTRY_DUSTOX[];
extern const u8 DEX_ENTRY_LOTAD[];
extern const u8 DEX_ENTRY_LOMBRE[];
extern const u8 DEX_ENTRY_LUDICOLO[];
extern const u8 DEX_ENTRY_SEEDOT[];
extern const u8 DEX_ENTRY_NUZLEAF[];
extern const u8 DEX_ENTRY_SHIFTRY[];
extern const u8 DEX_ENTRY_NINCADA[];
extern const u8 DEX_ENTRY_NINJASK[];
extern const u8 DEX_ENTRY_SHEDINJA[];
extern const u8 DEX_ENTRY_TAILLOW[];
extern const u8 DEX_ENTRY_SWELLOW[];
extern const u8 DEX_ENTRY_SHROOMISH[];
extern const u8 DEX_ENTRY_BRELOOM[];
extern const u8 DEX_ENTRY_SPINDA[];
extern const u8 DEX_ENTRY_WINGULL[];
extern const u8 DEX_ENTRY_PELIPPER[];
extern const u8 DEX_ENTRY_SURSKIT[];
extern const u8 DEX_ENTRY_MASQUERAIN[];
extern const u8 DEX_ENTRY_WAILMER[];
extern const u8 DEX_ENTRY_WAILORD[];
extern const u8 DEX_ENTRY_SKITTY[];
extern const u8 DEX_ENTRY_DELCATTY[];
extern const u8 DEX_ENTRY_KECLEON[];
extern const u8 DEX_ENTRY_BALTOY[];
extern const u8 DEX_ENTRY_CLAYDOL[];
extern const u8 DEX_ENTRY_NOSEPASS[];
extern const u8 DEX_ENTRY_TORKOAL[];
extern const u8 DEX_ENTRY_SABLEYE[];
extern const u8 DEX_ENTRY_BARBOACH[];
extern const u8 DEX_ENTRY_WHISCASH[];
extern const u8 DEX_ENTRY_LUVDISC[];
extern const u8 DEX_ENTRY_CORPHISH[];
extern const u8 DEX_ENTRY_CRAWDAUNT[];
extern const u8 DEX_ENTRY_FEEBAS[];
extern const u8 DEX_ENTRY_MILOTIC[];
extern const u8 DEX_ENTRY_CARVANHA[];
extern const u8 DEX_ENTRY_SHARPEDO[];
extern const u8 DEX_ENTRY_TRAPINCH[];
extern const u8 DEX_ENTRY_VIBRAVA[];
extern const u8 DEX_ENTRY_FLYGON[];
extern const u8 DEX_ENTRY_MAKUHITA[];
extern const u8 DEX_ENTRY_HARIYAMA[];
extern const u8 DEX_ENTRY_ELECTRIKE[];
extern const u8 DEX_ENTRY_MANECTRIC[];
extern const u8 DEX_ENTRY_NUMEL[];
extern const u8 DEX_ENTRY_CAMERUPT[];
extern const u8 DEX_ENTRY_SPHEAL[];
extern const u8 DEX_ENTRY_SEALEO[];
extern const u8 DEX_ENTRY_WALREIN[];
extern const u8 DEX_ENTRY_CACNEA[];
extern const u8 DEX_ENTRY_CACTURNE[];
extern const u8 DEX_ENTRY_SNORUNT[];
extern const u8 DEX_ENTRY_GLALIE[];
extern const u8 DEX_ENTRY_LUNATONE[];
extern const u8 DEX_ENTRY_SOLROCK[];
extern const u8 DEX_ENTRY_AZURILL[];
extern const u8 DEX_ENTRY_SPOINK[];
extern const u8 DEX_ENTRY_GRUMPIG[];
extern const u8 DEX_ENTRY_PLUSLE[];
extern const u8 DEX_ENTRY_MINUN[];
extern const u8 DEX_ENTRY_MAWILE[];
extern const u8 DEX_ENTRY_MEDITITE[];
extern const u8 DEX_ENTRY_MEDICHAM[];
extern const u8 DEX_ENTRY_SWABLU[];
extern const u8 DEX_ENTRY_ALTARIA[];
extern const u8 DEX_ENTRY_WYNAUT[];
extern const u8 DEX_ENTRY_DUSKULL[];
extern const u8 DEX_ENTRY_DUSCLOPS[];
extern const u8 DEX_ENTRY_ROSELIA[];
extern const u8 DEX_ENTRY_SLAKOTH[];
extern const u8 DEX_ENTRY_VIGOROTH[];
extern const u8 DEX_ENTRY_SLAKING[];
extern const u8 DEX_ENTRY_GULPIN[];
extern const u8 DEX_ENTRY_SWALOT[];
extern const u8 DEX_ENTRY_TROPIUS[];
extern const u8 DEX_ENTRY_WHISMUR[];
extern const u8 DEX_ENTRY_LOUDRED[];
extern const u8 DEX_ENTRY_EXPLOUD[];
extern const u8 DEX_ENTRY_CLAMPERL[];
extern const u8 DEX_ENTRY_HUNTAIL[];
...
extern const u8 DEX_ENTRY_ARON[];
extern const u8 DEX_ENTRY_LAIRON[];
extern const u8 DEX_ENTRY_AGGRON[];
extern const u8 DEX_ENTRY_CASTFORM[];
extern const u8 DEX_ENTRY_VOLBEAT[];
extern const u8 DEX_ENTRY_ILLUMISE[];
extern const u8 DEX_ENTRY_LILEEP[];
extern const u8 DEX_ENTRY_CRADILY[];
extern const u8 DEX_ENTRY_ANORITH[];
extern const u8 DEX_ENTRY_ARMALDO[];
extern const u8 DEX_ENTRY_RALTS[];
extern const u8 DEX_ENTRY_KIRLIA[];
extern const u8 DEX_ENTRY_GARDEVOIR[];
extern const u8 DEX_ENTRY_BAGON[];
extern const u8 DEX_ENTRY_SHELGON[];
extern const u8 DEX_ENTRY_SALAMENCE[];
extern const u8 DEX_ENTRY_BELDUM[];
extern const u8 DEX_ENTRY_METANG[];
extern const u8 DEX_ENTRY_METAGROSS[];
extern const u8 DEX_ENTRY_REGIROCK[];
extern const u8 DEX_ENTRY_REGICE[];
extern const u8 DEX_ENTRY_REGISTEEL[];
extern const u8 DEX_ENTRY_KYOGRE[];
extern const u8 DEX_ENTRY_GROUDON[];
extern const u8 DEX_ENTRY_RAYQUAZA[];
extern const u8 DEX_ENTRY_LATIAS[];
extern const u8 DEX_ENTRY_LATIOS[];
extern const u8 DEX_ENTRY_JIRACHI[];
extern const u8 DEX_ENTRY_DEOXYS[];
extern const u8 DEX_ENTRY_CHIMECHO[];
